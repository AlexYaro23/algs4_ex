...
var Quick = function (_Sorter) {
    _inherits(Quick, _Sorter);
    ...
    function Quick() {
        ...
        return _possibleConstructorReturn(this, (Quick.__proto__ || Object.getPrototypeOf(Quick)).call(this, arr));
    }
    ...
    _createClass(Quick, [{
        ...
        key: 'partition',
        value: function partition(lo, hi) {
            var i = lo;
            var j = hi + 1;
            var v = this.arr[lo];
